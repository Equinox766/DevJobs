<div class="p-10">
    <div class="mb-5">
        ...
        <div class="md:grid md:grid-cols-2 bg-gray-700 p-4 my-10 rounded-lg">
            ...
            <p class="font-bold text-sm uppercase text-gray-400 my-3">Último día para postularse:
    ...
    @guest
        <div class="mt-5 bg-gray-700 border-dashed text-center p-5 rounded-lg">
            <p>
                ¿Deseas aplicar a esta vacante? <a class="text-indigo-300 font-bold" href="{{route('register')}}">Obten una cuenta y aplica a esta y a otras vacantes.</a>
            </p>
        </div>
    @endguest
</div>
